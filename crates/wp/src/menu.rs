...
pub static MENUS: &[Menu] = &[
    ...
    Menu {
        ...
        items: &[
            ...
            C(Cmd::ColumnsThree),
            Sep,
            C(Cmd::SectionBreakNextPage),
            C(Cmd::SectionBreakContinuous),
            C(Cmd::SectionBreakOddPage),
            C(Cmd::SectionBreakEvenPage),
            Sep,
            C(Cmd::HeaderEdit),
            C(Cmd::HeaderEditFirst),
            C(Cmd::HeaderEditEven),
            C(Cmd::FooterEdit),
            C(Cmd::FooterEditFirst),
            C(Cmd::FooterEditEven),
            C(Cmd::HeaderFooterDone),
            C(Cmd::HeaderRemove),
            C(Cmd::FooterRemove),
            C(Cmd::TitlePage),
            C(Cmd::EvenOddHeaders),
        ],
    },
    Menu {
        title: "Font",
    ...
    Menu {
        ...
        items: &[
            ...
            C(Cmd::InsertTab),
            C(Cmd::Date),
            C(Cmd::InsertPageNumber),
            C(Cmd::InsertPageCount),
            C(Cmd::Bookmark),
            Sep,
            C(Cmd::ListBullet),
            C(Cmd::ListNumber),
    ...
    Menu {
        ...
        items: &[
            ...
            Sep,
            C(Cmd::TableColWidth),
            C(Cmd::TableRowHeight),
            C(Cmd::TableHeaderRow),
            C(Cmd::TableRowCantSplit),
            Sep,
            C(Cmd::TableMergeCells),
            C(Cmd::TableSplitCell),
            Sep,
            C(Cmd::TableBordersAll),
            C(Cmd::TableBordersNone),
            C(Cmd::TableBordersOutside),
            C(Cmd::TableBordersInside),
            C(Cmd::TableCellBordersAll),
            C(Cmd::TableCellBordersNone),
            C(Cmd::TableCellShading),
            Sep,
            C(Cmd::TableSortAsc),
            C(Cmd::TableSortDesc),
            C(Cmd::TableFormula),
            C(Cmd::TableRecalculate),
            C(Cmd::TableInsertTab),
            Sep,
            C(Cmd::TableToText),
            C(Cmd::TableDelete),
        ],
